    ...
    <main>
        <section id="container-admin">
            <form action="" method='POST'>
                <input type="text" name="news_website" placeholder="actualité du site*" size="95">
                <button type="submit" name="del_account">AFFICHER SUR LE SITE</button>
            </form>

            <form action="" method='POST'>
                <input type="text" name="news_website" placeholder="actualité du site*" size="95">
                <button type="submit" name="del_account">MOYEN DE LIVRAISON</button>
            </form>
        </section>
