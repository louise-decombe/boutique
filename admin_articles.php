   ...
   <form method="post" action="action_article.php" class="form">
     <section id="box-form">
      ...
      foreach ($products as $product):
                      ...
                      <input type="hidden" name="action_type" value="add"/>
                      <input type="submit" class="submit-bouton" name="submit_form1" value="Valider"/>
                    </form>
                  </section>
                  </section>
                  </section>
...
if (isset($_GET['submit_form1'])) { ?>
  ...
  <input type="submit" class="submit-bouton" name="submit_form2" value="Valider">
  </form>
</section>
</section>
...
<?php if (isset($_GET['submit_form2'])) {?>
  <section id="container-register">
    <form id="" method="POST">
            ...
            <input type="submit"  class="submit-bouton" name="submit1" value="Upload">
          </form>
          ...
          <form id="formfiles" action="upload.php?id=<?php ?>" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" class="submit-bouton" name="submit" value="Upload">
            </div>
                </section>
                  </form>
