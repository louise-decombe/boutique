...
--
-- Hôte : localhost
-- Généré le : mar. 01 sep. 2020 à 21:32
...
(1, 'abc', 4, '2020-09-01 19:21:28'),
(3, 'zadq', 4, '2020-09-01 19:22:48');
...
(1, 'aez@mail.com', 'az', 'zaez', 'aze', '2020-09-01 19:08:32'),
(2, 'aez@mail.com', 'az', 'zaez', 'azesf', '2020-09-01 19:08:41');
...
(16, 'mad', 'na', 'Homme', '0123456789', 'nad@gmail.com', '$2y$10$8Bn8S/QqDHzI25XSwnqbjOyeusoi1e0nH706ux91sreAQEk18Dc/q', 0, '2020-08-07 09:21:53');
...
INSERT INTO `wishlist` (`id`, `id_utilisateur`, `id_article`, `date_registration`) VALUES
(15, 4, 5, '2020-08-31 15:42:01'),
(16, 4, 5, '2020-08-31 15:42:02'),
(17, 4, 2, '2020-09-01 17:17:12'),
(18, 4, 2, '2020-09-01 17:17:14');
...
--
ALTER TABLE `message_utilisateurs`
  MODIFY `id_message_utilisateur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `message_vendeur`
--
ALTER TABLE `message_vendeur`
  MODIFY `id_message_vendeur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
