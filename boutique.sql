...
--
-- Hôte : localhost
-- Généré le : jeu. 27 août 2020 à 23:22
...
(1, 'musique', '0000-00-00 00:00:00'),
(2, 'art & architecture', '0000-00-00 00:00:00'),
(3, 'littérature', '0000-00-00 00:00:00'),
(4, 'contre-culture', '0000-00-00 00:00:00'),
(5, 'jeunesse', '0000-00-00 00:00:00'),
(6, 'manga', '0000-00-00 00:00:00'),
(8, 'lal', '2020-08-27 19:37:37');
...
--
-- Déchargement des données de la table `message_utilisateurs`
--

INSERT INTO `message_utilisateurs` (`id_message_utilisateur`, `message_utilisateur`, `id_utilisateur`, `date_registration`) VALUES
(1, 'maz', 1, '2020-08-26 16:22:18');
...
--
-- Déchargement des données de la table `message_vendeur`
--

INSERT INTO `message_vendeur` (`id_message_vendeur`, `email_utilisateur`, `message_vendeur`, `description_article_vendeur`, `titre_fanzine`, `date_registration`) VALUES
(1, 'ab ', 'abc@mail.com', 'malziefdsno', 'aZIEOUSDKN,SCOIZIO', '2020-08-26 21:46:20'),
(2, 'zaer', 'azer@mail.com', 'aopezdnlsq', 'lkzejrfqoiinqs', '2020-08-26 22:02:17'),
(3, 'zaer', 'azer@mail.com', 'aopezdnlsq', 'lkzejrfqoiinqs', '2020-08-26 22:02:47');
...
(1, 'brutalisme', 2, '0000-00-00 00:00:00'),
(2, 'architectes', 2, '0000-00-00 00:00:00'),
(3, 'street-art', 4, '0000-00-00 00:00:00'),
(4, 'science-fiction', 3, '0000-00-00 00:00:00'),
(6, 'généraliste', 1, '0000-00-00 00:00:00'),
(7, 'auto-fiction', 3, '0000-00-00 00:00:00'),
(9, 'théorie', 2, '0000-00-00 00:00:00');
...
INSERT INTO `utilisateurs` (`id_utilisateur`, `prenom`, `nom`, `gender`, `phone`, `email`, `password`, `is_admin`, `date_registration`, `modified`) VALUES
(1, 'admin', 'admin', 'non-genré', '0658449105', 'admin@gmail.com', 'Password-1', 1, '2020-08-03 10:00:00', '0000-00-00 00:00:00'),
(2, 'Nadia', 'RAIS', 'Femme', '0494662823', 'ndrs455@gmail.com', '$2y$10$2T5GS0b30.Oxzo01slrr6OqqS6ZtKs7P2Z/.Jjvx0jWSEEOINnvgS', 0, '2020-08-03 16:51:49', '0000-00-00 00:00:00'),
(3, 'ruben', 'ruben', 'Homme', '0658449191', 'ruben@gmail.com', '$2y$10$.yFTv1arLWo9dxUc8B15a.05vChbmJ4zypNUdf9p14ffnznYzLcVm', 0, '2020-08-04 09:37:29', '0000-00-00 00:00:00'),
(4, 'nadia', 'nadia', 'Femme', '0123456789', 'nadia@gmail.com', '$2y$10$aGUljOx4rg.OEr3kQIXF0ukJxYAgE7J2Jiayv56zUMJIoN7pbO5xe', 0, '2020-08-04 14:35:11', '0000-00-00 00:00:00');
...
--
-- Index pour la table `message_utilisateurs`
--
...
--
-- AUTO_INCREMENT pour la table `message_utilisateurs`
--
ALTER TABLE `message_utilisateurs`
  MODIFY `id_message_utilisateur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `message_vendeur`
--
ALTER TABLE `message_vendeur`
  MODIFY `id_message_vendeur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `newsletter`
--
ALTER TABLE `newsletter`
  MODIFY `id_newsletter` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
