...
<body>
    ...
    <main>
  	<center>	<h1>HIGH & CRAFT FANZINE BOOKSTORE - Conditions Générales de Vente
</h1></center>
          ...
          <div class="box">
            ...
            <p>  Vous pouvez passer commande :
              ...
              La société HIGH & CRAFT FANZINE BOOKSTORE se réserve le droit de ne pas enregistrer un paiement, et de ne pas confirmer une commande pour quelque raison que ce soit, et plus particulièrement en cas de problème d'approvisionnement, ou en cas de difficulté concernant la commande reçue.
                ...
                <section class="container">
                  <h3>Article 4 - Validation de votre commande
                  </h3>
                  <div class="box">
                                              ...
                                              <div class="box">
                                                ...
                                                <section class="container">
                                                  ...
                                                  <div class="box">
                                                    ...
                                                    <section class="container">
                                                      <h3>Article 11 - Droit applicable en cas de litiges
                                                      </h3>
                                                      <div class="box">
                                                        ...
                                                        <section class="container">
                                                          <h3> Article 12 - Propriété intellectuelle
                                                          </h3>
                                                          <div class="box">
                                                            ...
                                                            <section class="container">
                                                              <h3> Article 13 - Données personnelles
                                                              </h3>
                                                              <div class="box">
                                                                ...
                                                                <section class="container">
                                                                  <h3>Article 14 - Archivage Preuve
                                                                  </h3>
                                                                  <div class="box">
